...
public class Scanner extends AbstractScanner {
    ...
    private static final int[][] TABLE = {
            {LEFT_BRACE, NAME, RIGHT_BRACE, ERROR, COMMA, LEFT_SQ_BR, RIGHT_SQ_BR, COLON, ERROR, D_Q, END, ERROR, WS, ERROR, AT, ERROR}, //START
            ...
            {S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R}, // RIGHT_SQ_BR
            {S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, ERROR, ERROR, ERROR}, // COMMA
            {S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R, S_R}, //STAR
    ...
    private IToken onReturn(Position start, int state, String value) {
        ...
        switch (state) {
            ...
            case AT:
                return new StarToken(value, fragment);
            case COLON:
